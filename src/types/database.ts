...
//
// HAND-EDITED in P1: the additions from
// supabase/migrations/20260812093000_review_card.sql (cards.learning_steps, the
// reviews before-snapshot columns and undone_at, and the review_card /
// undo_last_review functions) are written in by hand because that migration has
// not been pushed yet — pushing is the owner's call, not a session's. Re-run
// `npm run db:types` once it is applied and this note can go.
